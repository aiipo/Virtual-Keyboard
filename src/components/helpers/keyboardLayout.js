  ...
  return {
    ...
    ru: [
      ...
      [
        ...
        {
          code: 'KeyW', key: 'ц', keyShift: 'Ц',
        },
        {
          code: 'KeyE', key: 'у', keyShift: 'У',
        },
        {
          code: 'KeyR', key: 'к', keyShift: 'К',
        },
        {
          code: 'KeyT', key: 'е', keyShift: 'Е',
        },
        {
          code: 'KeyY', key: 'н', keyShift: 'Н',
        },
        {
          code: 'KeyU', key: 'г', keyShift: 'Г',
        },
        {
          code: 'KeyI', key: 'ш', keyShift: 'Ш',
        },
        {
          code: 'KeyO', key: 'щ', keyShift: 'Щ',
        },
        {
          code: 'KeyP', key: 'з', keyShift: 'З',
        },
        {
          code: 'BracketLeft', key: 'х', keyShift: 'Х',
        },
        {
      ...
      [
        ...
        {
          code: 'KeyS', key: 'ы', keyShift: 'Ы',
        },
        {
          code: 'KeyD', key: 'в', keyShift: 'В',
        },
        {
          code: 'KeyF', key: 'а', keyShift: 'А',
        },
        {
          code: 'KeyG', key: 'п', keyShift: 'П',
        },
        {
          code: 'KeyH', key: 'р', keyShift: 'Р',
        },
        {
          code: 'KeyJ', key: 'о', keyShift: 'О',
        },
        {
          code: 'KeyK', key: 'л', keyShift: 'Л',
        },
        {
          code: 'KeyL', key: 'д', keyShift: 'Д',
        },
        {
          code: 'Semicolon', key: 'ж', keyShift: 'Ж',
        },
        {
      ...
      [
        ...
        {
          code: 'KeyZ', key: 'я', keyShift: 'Я',
        },
        {
          code: 'KeyX', key: 'ч', keyShift: 'Ч',
        },
        {
          code: 'KeyC', key: 'с', keyShift: 'С',
        },
        {
          code: 'KeyV', key: 'м', keyShift: 'М',
        },
        {
          code: 'KeyB', key: 'и', keyShift: 'И',
        },
        {
          code: 'KeyN', key: 'т', keyShift: 'Т',
        },
        {
          code: 'KeyM', key: 'ь', keyShift: 'Ь',
        },
        {
          code: 'Comma', key: 'б', keyShift: 'Б',
        },
        {
